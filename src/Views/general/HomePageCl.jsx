      ...
      <main className="container my-5 mt-5 pt-5">
        ...
        <section className="mb-5">
          <div className="row g-4">
            ...
            {/* Tarjeta 6: Manual de Usuario (Cliente) */}
            <div className="col-12 col-sm-6 col-lg-4">
              <div className="card h-100 border-0 shadow-sm hover-card">
                <div className="card-body d-flex flex-column">
                  <div className="d-inline-flex align-items-center justify-content-center rounded-circle mb-3"
                    style={{ width: '56px', height: '56px', backgroundColor: '#eef2ff' }}>
                    <svg xmlns="http://www.w3.org/2000/svg" height="32px" viewBox="0 -960 960 960" width="32px" fill="currentcolor"><path d="M400-400h160v-80H400v80Zm0-120h320v-80H400v80Zm0-120h320v-80H400v80Zm-80 400q-33 0-56.5-23.5T240-320v-480q0-33 23.5-56.5T320-880h480q33 0 56.5 23.5T880-800v480q0 33-23.5 56.5T800-240H320Zm0-80h480v-480H320v480ZM160-80q-33 0-56.5-23.5T80-160v-560h80v560h560v80H160Zm160-720v480-480Z"/></svg>
                  </div>
                  <h5 className="card-title fw-semibold text-dark">Manual</h5>
                  <p className="card-text text-muted flex-grow-1">
                    Consulta el manual para aprender a usar la plataforma.
                  </p>
